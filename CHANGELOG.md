...
* don't ignore custom hostname overrides for VCS providers ([#855](https://github.com/bvgroup-co/otf/issues/855))
* 
* rename --address flag to --url; require scheme
* move to sqlc, tern ([#683](https://github.com/bvgroup-co/otf/issues/683))
* agent pools ([#653](https://github.com/bvgroup-co/otf/issues/653))

### refactor

* move to sqlc, tern ([#683](https://github.com/bvgroup-co/otf/issues/683)) ([878ebfb](https://github.com/bvgroup-co/otf/commit/878ebfba5eea34926b2f3aebe9bce8f826347b20))
* rename --address flag to --url; require scheme ([3e83474](https://github.com/bvgroup-co/otf/commit/3e834744e2eff9984dd29255b53f489aa857e2dc))


### Features

* Add compatibility for TFC environment variables. ([#923](https://github.com/bvgroup-co/otf/issues/923)) ([b3f9aa6](https://github.com/bvgroup-co/otf/commit/b3f9aa68a9b2106dc8c82ae0206128f438e548cd))
* add flags --oidc-username-claim and --oidc-scopes ([#605](https://github.com/bvgroup-co/otf/issues/605)) ([87324d0](https://github.com/bvgroup-co/otf/commit/87324d00afbf7944516ed091f6014f4b3001c177)), closes [#596](https://github.com/bvgroup-co/otf/issues/596)
* add forgejo vcs provider ([#771](https://github.com/bvgroup-co/otf/issues/771)) ([dbb3c0a](https://github.com/bvgroup-co/otf/commit/dbb3c0a5221a3c5f78e5244a4fecc74116046a6b))
* add job image flag for kubernetes executor ([#922](https://github.com/bvgroup-co/otf/issues/922)) ([0010dcd](https://github.com/bvgroup-co/otf/commit/0010dcd707938b047cb7a67a3a0ea42bfcd5b2d7))
* add option to skip plans for pull requests ([#714](https://github.com/bvgroup-co/otf/issues/714)) ([29455ed](https://github.com/bvgroup-co/otf/commit/29455ed335cf556702bca750bcc18e5b53d82a3e))
* add resource limits and labels flags for kubernetes job ([#915](https://github.com/bvgroup-co/otf/issues/915)) ([b89d364](https://github.com/bvgroup-co/otf/commit/b89d3641ecb57772d70cef3eca92c05d069888a8)), closes [#896](https://github.com/bvgroup-co/otf/issues/896)
* add support for opentofu ([#763](https://github.com/bvgroup-co/otf/issues/763)) ([c5e4742](https://github.com/bvgroup-co/otf/commit/c5e474208efec4464bf06383cb83d2321d7d2df3))
* add timeout settings for plans and applies ([#686](https://github.com/bvgroup-co/otf/issues/686)) ([797902b](https://github.com/bvgroup-co/otf/commit/797902bc8187a8b1682d340abab730a58247c304))
* Add Webhook Hostname ([#668](https://github.com/bvgroup-co/otf/issues/668)) ([#670](https://github.com/bvgroup-co/otf/issues/670)) ([f2dc7e9](https://github.com/bvgroup-co/otf/commit/f2dc7e9425dca693cf9adff11aada0217d5cce7e))
* agent pools ([#653](https://github.com/bvgroup-co/otf/issues/653)) ([662bfd9](https://github.com/bvgroup-co/otf/commit/662bfd9bbd5aff7a6bc9e94253a5ac525aedc113))
* allow subscription buffer size to be overridden ([#687](https://github.com/bvgroup-co/otf/issues/687)) ([d51469d](https://github.com/bvgroup-co/otf/commit/d51469d84534e22bd6b4ef3ee55a76582d58aec4))
* allow user to specify URL per VCS provider ([#813](https://github.com/bvgroup-co/otf/issues/813)) ([c792756](https://github.com/bvgroup-co/otf/commit/c792756a308514e491e5b0a531ab72556dd98d4e))
* always use latest terraform version ([#616](https://github.com/bvgroup-co/otf/issues/616)) ([83469ca](https://github.com/bvgroup-co/otf/commit/83469ca998b8756673cc9ff06c8225bd3cc62e61)), closes [#608](https://github.com/bvgroup-co/otf/issues/608)
* bump default terraform and tofu to latest version ([8a67e73](https://github.com/bvgroup-co/otf/commit/8a67e7342d3bc3a54aa4d1ab0e66d95b7fbb2d3e))
* delete configs older than a user-specified duration ([#845](https://github.com/bvgroup-co/otf/issues/845)) ([b54bd3f](https://github.com/bvgroup-co/otf/commit/b54bd3ff2548d0bac7c70e4f3e9409e69d1537fe))
* delete runs after user-specified time period ([#844](https://github.com/bvgroup-co/otf/issues/844)) ([fb5547c](https://github.com/bvgroup-co/otf/commit/fb5547c75f4f6872c69e59a376b8cf0ddf25cb27)), closes [#834](https://github.com/bvgroup-co/otf/issues/834)
* docker compose install ([#862](https://github.com/bvgroup-co/otf/issues/862)) ([c9946a6](https://github.com/bvgroup-co/otf/commit/c9946a6858f1c60d876eb245959174d6526d231b)), closes [#850](https://github.com/bvgroup-co/otf/issues/850)
* **docs:** add search ([aa5d43b](https://github.com/bvgroup-co/otf/commit/aa5d43b6fdbd8115628b11bd6425bd63d3fc9aa4))
* dynamic provider credentials ([#806](https://github.com/bvgroup-co/otf/issues/806)) ([aab0a9b](https://github.com/bvgroup-co/otf/commit/aab0a9b80ce9d97ec3ed487c1ecfadac3cc14c81))
* execute runs in kubernetes jobs ([#867](https://github.com/bvgroup-co/otf/issues/867)) ([0d22da8](https://github.com/bvgroup-co/otf/commit/0d22da8d893236173f9f6f118d050c45fd41b830)), closes [#866](https://github.com/bvgroup-co/otf/issues/866)
* extend helm charts values to add volumes, volumeMounts and sidecars ([#807](https://github.com/bvgroup-co/otf/issues/807)) ([94147b5](https://github.com/bvgroup-co/otf/commit/94147b548cf02e78d0e5b6b59acec603ec89bcfc))
* forgejo provider uses gitea webhooks, for compatibility with both ([#793](https://github.com/bvgroup-co/otf/issues/793)) ([9628f8a](https://github.com/bvgroup-co/otf/commit/9628f8a3dad6197c66225184f919ae1c4dee63bf)), closes [#792](https://github.com/bvgroup-co/otf/issues/792)
* **gitlab:** implement SetStatus to update commit status in GitLab ([#929](https://github.com/bvgroup-co/otf/issues/929)) ([e86f20a](https://github.com/bvgroup-co/otf/commit/e86f20aa08e407a1828a5d481b32b1153d38c170))
* log the reason why agent is retrying api request ([1d41f61](https://github.com/bvgroup-co/otf/commit/1d41f61a1257da0bf473af9efc969f0f21ca78f8))
* merge session advisory locks into one ([#939](https://github.com/bvgroup-co/otf/issues/939)) ([6f21969](https://github.com/bvgroup-co/otf/commit/6f219693d96eb567c557f09cc014ac07a4db940a))
* new workspace now uses latest engine version ([bd40d22](https://github.com/bvgroup-co/otf/commit/bd40d22198f853171afcb2811bbeb22f727417ce))
* order workspaces lexicographically ([66a2b00](https://github.com/bvgroup-co/otf/commit/66a2b00665cfe45b81038b4a374ac639e53a0c71))
* passthrough command-line parameters which affect planning ([#859](https://github.com/bvgroup-co/otf/issues/859)) ([b9405d0](https://github.com/bvgroup-co/otf/commit/b9405d09b58431a820a0bec94969d929dc5bd436))
* run as non-root user in container ([#823](https://github.com/bvgroup-co/otf/issues/823)) ([06ced51](https://github.com/bvgroup-co/otf/commit/06ced5159e610998833a5a5ffad36395fbf0ff18))
* run status metrics ([#697](https://github.com/bvgroup-co/otf/issues/697)) ([4642e5d](https://github.com/bvgroup-co/otf/commit/4642e5d98937ca036f68681ab5abef9ed14379d2))
* run triggers ([#942](https://github.com/bvgroup-co/otf/issues/942)) ([a2c051b](https://github.com/bvgroup-co/otf/commit/a2c051b3d8511f99733309ab90c2fd7fc262622f)), closes [#614](https://github.com/bvgroup-co/otf/issues/614)
* ssh keys ([#900](https://github.com/bvgroup-co/otf/issues/900)) ([9bf1dbb](https://github.com/bvgroup-co/otf/commit/9bf1dbbb3626644fc756f17b35b860e3fd299241)), closes [#899](https://github.com/bvgroup-co/otf/issues/899)
* **tests:** add browser tracing ([10fd15d](https://github.com/bvgroup-co/otf/commit/10fd15dc1a78ab51c4cf4fa651707b9ca9d0444f))
* **ui:** add filter for workspace current run status ([#734](https://github.com/bvgroup-co/otf/issues/734)) ([f3b2c85](https://github.com/bvgroup-co/otf/commit/f3b2c85dd19973c5afa04a82987fc6a3db468584))
* **ui:** add page size selector ([#733](https://github.com/bvgroup-co/otf/issues/733)) ([06efdf5](https://github.com/bvgroup-co/otf/commit/06efdf53150145cf07189b33e000c4170d4e433b))
* **ui:** add side menu ([d628f81](https://github.com/bvgroup-co/otf/commit/d628f81f16fac260a089d3a1bcef7d3c4ddfe3c9))
* **ui:** add theme selector ([97a4aa1](https://github.com/bvgroup-co/otf/commit/97a4aa18371a9cdcd849360329b2cd2f3ccc1b16))
* **ui:** add workspace overview sub menu link ([892381f](https://github.com/bvgroup-co/otf/commit/892381f1b96b00db54151546b63743f3b18b369f))
* **ui:** clickable widgets ([#597](https://github.com/bvgroup-co/otf/issues/597)) ([518452e](https://github.com/bvgroup-co/otf/commit/518452ede3d458e1bd0105f2a0a46ab5b5cb36c6))
* **ui:** filter modules by provider ([8af8e56](https://github.com/bvgroup-co/otf/commit/8af8e56af846338177e6658bab3bb62efa33b50c))
* **ui:** filter runs by status ([#737](https://github.com/bvgroup-co/otf/issues/737)) ([8780849](https://github.com/bvgroup-co/otf/commit/8780849e57f45568decdc64e7d4e70a0a1132316))
* **ui:** improve styling ([06a6bce](https://github.com/bvgroup-co/otf/commit/06a6bce864225346ca00c6725bac3b66b06f56d9))
* **ui:** let browser cache responses for better perf ([c76a29a](https://github.com/bvgroup-co/otf/commit/c76a29a8e4934a78cfccfec253b3587f3471b8b6))
* **ui:** make lock widget nicer ([7df67d9](https://github.com/bvgroup-co/otf/commit/7df67d949b5caf92757f5104e03d42be4373de67))
* **ui:** move theme selecter to navbar ([af37fe7](https://github.com/bvgroup-co/otf/commit/af37fe7f5b25121b599bf92fec9230b12701f2eb))
* **ui:** organization runs view ([#739](https://github.com/bvgroup-co/otf/issues/739)) ([dad98f7](https://github.com/bvgroup-co/otf/commit/dad98f7ccb1e46ba1c1dd4d507f9eeb3b13a3704))
* **ui:** organization settings menu ([#935](https://github.com/bvgroup-co/otf/issues/935)) ([66d7999](https://github.com/bvgroup-co/otf/commit/66d79993f7a40f3b5ef98c4b81cec220b31910c2))
* **ui:** re-style workspace main page ([d0084b5](https://github.com/bvgroup-co/otf/commit/d0084b595f92a08e788339acc1595521ba1b4301))
* **ui:** revamp menu layout ([#884](https://github.com/bvgroup-co/otf/issues/884)) ([0510bce](https://github.com/bvgroup-co/otf/commit/0510bce29341a11795147387754049b91b714d9a))
* **ui:** show running times ([#635](https://github.com/bvgroup-co/otf/issues/635)) ([7337c2e](https://github.com/bvgroup-co/otf/commit/7337c2ecde3876c51ab77ae477f7664c264f42a3)), closes [#604](https://github.com/bvgroup-co/otf/issues/604)
* **ui:** state viewer ([#904](https://github.com/bvgroup-co/otf/issues/904)) ([158172a](https://github.com/bvgroup-co/otf/commit/158172aa88f533393d9465059d883399e9bfb926)), closes [#863](https://github.com/bvgroup-co/otf/issues/863)
* **ui:** tabulate all resources ([#754](https://github.com/bvgroup-co/otf/issues/754)) ([fcc78be](https://github.com/bvgroup-co/otf/commit/fcc78bec59291b4bd70364dc29e6fcad401be56c))
* **ui:** tabulate workspace and run listings ([#741](https://github.com/bvgroup-co/otf/issues/741)) ([31ab7ce](https://github.com/bvgroup-co/otf/commit/31ab7ce8130171ee586a0ddbaff89a6e15248ddf))
* **ui:** use flash messages for POST errors ([23a969f](https://github.com/bvgroup-co/otf/commit/23a969ff1712139fbc233f93ff0e26d3f30fb718))
* **ui:** user avatars ([f35efdd](https://github.com/bvgroup-co/otf/commit/f35efdd5a703282645b3239d610421d360bba6be))
* **ui:** workspace settings submenu ([#933](https://github.com/bvgroup-co/otf/issues/933)) ([97d1fe9](https://github.com/bvgroup-co/otf/commit/97d1fe98c6279b055d51b438ac31effa8cc02a41))
* update vcs provider token ([#594](https://github.com/bvgroup-co/otf/issues/594)) ([29a0be6](https://github.com/bvgroup-co/otf/commit/29a0be667046440aab25efc25c9a7a02720d2f96)), closes [#576](https://github.com/bvgroup-co/otf/issues/576)


### Bug Fixes

* "Save variable set" button on the variableset edit page ([#778](https://github.com/bvgroup-co/otf/issues/778)) ([ed7a3d2](https://github.com/bvgroup-co/otf/commit/ed7a3d2d094198a304bd17fc705c8768db94d087))
* /healthz returns 503 when db unreachable ([#924](https://github.com/bvgroup-co/otf/issues/924)) ([813ab87](https://github.com/bvgroup-co/otf/commit/813ab87ec873438d4fde19491cee6a88b98322cc))
* a bad background color on the oauth2 confirmation page ([#786](https://github.com/bvgroup-co/otf/issues/786)) ([09b3366](https://github.com/bvgroup-co/otf/commit/09b33667ecde38db970097f6e24dbef7c2841b89))
* add `--allowed-origins` parameter ([#773](https://github.com/bvgroup-co/otf/issues/773)) ([b0c83ed](https://github.com/bvgroup-co/otf/commit/b0c83edf7db096fb839b405eebc999c256abee93))
* add arm and 386 arch testdata ([#740](https://github.com/bvgroup-co/otf/issues/740)) ([e24cdfa](https://github.com/bvgroup-co/otf/commit/e24cdfa957d0f6170f891052c7a1233e01747783))
* add caching to speed up run listings ([cbfeceb](https://github.com/bvgroup-co/otf/commit/cbfeceb054162e6e2a7243391265f30003bea761))
* add extra case for gitlab repo dir name ([#654](https://github.com/bvgroup-co/otf/issues/654)) ([5424565](https://github.com/bvgroup-co/otf/commit/542456530d8551c34bd2a2d298f931dee5c52827))
* add indices to boost perf and reduce db load ([04678fc](https://github.com/bvgroup-co/otf/commit/04678fc3a8d852d8619305ae181424e47a296090))
* add logs index to prevent workspace delete timeout ([e12dec5](https://github.com/bvgroup-co/otf/commit/e12dec56e850f2fafbafbf3be1ad8586f41a4b7b))
* Add missing CancelRunAction to WorkspaceWriteRole ([#649](https://github.com/bvgroup-co/otf/issues/649)) ([599ddcb](https://github.com/bvgroup-co/otf/commit/599ddcb5494de845ce6fe8e91240facf3b8fb466))
* add openssh to Docker image for SSH module sources ([#906](https://github.com/bvgroup-co/otf/issues/906)) ([60525fa](https://github.com/bvgroup-co/otf/commit/60525fa6d6155b7199920429d2765dfbebe292d6))
* add primary key to events table ([1cc6a21](https://github.com/bvgroup-co/otf/commit/1cc6a217197d7daf74bd0a00896db14a0f5763ab))
* agent error reporting ([#628](https://github.com/bvgroup-co/otf/issues/628)) ([76e7dda](https://github.com/bvgroup-co/otf/commit/76e7dda7a6d6ca29c8ee1cd8feecb3def0f77c44))
* **agent:** don't panic when server goes offline ([6017b6e](https://github.com/bvgroup-co/otf/commit/6017b6e0a77884709b0c53eea8c14e4ef84fcde8))
* **agent:** dynamic provider creds broken on agents ([acafaee](https://github.com/bvgroup-co/otf/commit/acafaee03f50dd86b179605604faa4fac6d70dc9))
* allocator not accounting for deleted jobs ([44ea11e](https://github.com/bvgroup-co/otf/commit/44ea11e504f06ea549bed7dd08c508b6572f7810))
* allocator restarting unnecessarily ([#666](https://github.com/bvgroup-co/otf/issues/666)) ([47f8e6f](https://github.com/bvgroup-co/otf/commit/47f8e6f74cd7fb36bf2b5eb3885bbd995bcf81c0))
* **allocator:** job capacity exceeded on runners ([#723](https://github.com/bvgroup-co/otf/issues/723)) ([53cae20](https://github.com/bvgroup-co/otf/commit/53cae20e1cb768cb2fc39c8bf476e84d1f2c0ee8))
* allow '@' in state output map keys ([9f838ee](https://github.com/bvgroup-co/otf/commit/9f838eed1ed7d3502d6f5f9c193f7c30b559aae7))
* allow email address for username ([ecf3a3d](https://github.com/bvgroup-co/otf/commit/ecf3a3ddf09f09cf87864cd6315074245ec94ead))
* allow org members to view variable sets ([df9fa53](https://github.com/bvgroup-co/otf/commit/df9fa53fad1e51c2c0b9e4d9ac4f493c5be66fb7))
* allow overriding source for a vcs kind ([40467e7](https://github.com/bvgroup-co/otf/commit/40467e7d2a7b70782baf1512b44c34145e34f8ea))
* allow release-please to create releases ([4756038](https://github.com/bvgroup-co/otf/commit/4756038ac3ededb06ab09eaf8a0e8fcaa193bcac))
* allow variable set with same name in another org ([8834ba2](https://github.com/bvgroup-co/otf/commit/8834ba26718ab2c9e2556afcc4ff55b20bf0353c))
* **api-client:** allow '@' in state output map keys ([79458e6](https://github.com/bvgroup-co/otf/commit/79458e648541824970ccc7344b511cc8815b14c8))
* **api-client:** provide more informative error logging ([27d7888](https://github.com/bvgroup-co/otf/commit/27d7888da0c2f07283e682cc07d7876b589ed461))
* **api:** log error when response cannot be marshaled ([fef1bc7](https://github.com/bvgroup-co/otf/commit/fef1bc79ddc13a6b0d23d820badacdc009b8cf2a))
* **auth:** don't log error if request doesn't have valid jwt ([3fd9dc5](https://github.com/bvgroup-co/otf/commit/3fd9dc51f9660ca22b6ee25ac59cb8d9bbb2b2ef))
* authorize create-org action on site, not org ([98bd1c6](https://github.com/bvgroup-co/otf/commit/98bd1c680e7fef486e622c9d1835d060df444265))
* avoid hitting Github limit on commit status updates ([#688](https://github.com/bvgroup-co/otf/issues/688)) ([029e525](https://github.com/bvgroup-co/otf/commit/029e5255a5ea70ea7701f11b16add510fb03b23f))
* avoid nil ptr ref panics when watching run ([cd5694d](https://github.com/bvgroup-co/otf/commit/cd5694dca4b0d5d7b0147ed056508ffeb4d686c9))
* avoid websocket handler infinite loop ([92ea015](https://github.com/bvgroup-co/otf/commit/92ea01547fd9c954bb7b56b66ac0e8ba331c6363))
* AWS dynamic provider credentials invalid apply absolute paths ([#822](https://github.com/bvgroup-co/otf/issues/822)) ([fc3162a](https://github.com/bvgroup-co/otf/commit/fc3162a35e8b51ff5d155f0eb097c3f96a03786e))
* AWS dynamic provider credentials requires kid field (Key ID) in JWK ([7d1bc8b](https://github.com/bvgroup-co/otf/commit/7d1bc8bd149b537d9205e2a6d24dc2411961e353))
* azure dyn cred provider no kid found error ([#828](https://github.com/bvgroup-co/otf/issues/828)) ([6d55d8e](https://github.com/bvgroup-co/otf/commit/6d55d8e78fcb1e787a150c6a3e9bbb241e1147dc))
* bad background colors on dark themes ([26fa6fc](https://github.com/bvgroup-co/otf/commit/26fa6fc3df2aff51d3bf8fc03b4c643f1dd7c193))
* bad git command in chart release step ([3ed91e3](https://github.com/bvgroup-co/otf/commit/3ed91e351a23c0d5ba858ff0423035194bc0471b))
* broken github workflow ([bf659cc](https://github.com/bvgroup-co/otf/commit/bf659cc65d60593ef4c4e95bd6501460d29b1716))
* broken mike python package for docs ([34c50e2](https://github.com/bvgroup-co/otf/commit/34c50e2f08b5a460b15ee38d9b319187d34a8516))
* bump packages to fix critical vulns ([b53a404](https://github.com/bvgroup-co/otf/commit/b53a404f91de2741681cc60e09324338cc4703a8))
* bump tailwind config to be compat with v4 ([402903d](https://github.com/bvgroup-co/otf/commit/402903d42023db6805965fe6b685587a1167eef1))
* **charts/otfd:** Adjust indentation for volume mounts in deployment.yaml ([#881](https://github.com/bvgroup-co/otf/issues/881)) ([67341d3](https://github.com/bvgroup-co/otf/commit/67341d38f2decd7a206921595bca217d8efa8462))
* **ci:** broke release process ([64716f9](https://github.com/bvgroup-co/otf/commit/64716f9bf7ce4edfb26d038fae518cb8e0cd24c8))
* **ci:** charts job needs release info ([f4fef03](https://github.com/bvgroup-co/otf/commit/f4fef03c3a594bdb21c63dcbe2d0c9aeef6c242d))
* **ci:** disable sbom for docker images ([7d56ea8](https://github.com/bvgroup-co/otf/commit/7d56ea8555c5484046919fbbc940b5c90cd990b0))
* **ci:** downgrade broken release please action ([f886124](https://github.com/bvgroup-co/otf/commit/f886124ea6f560f1b5be94afd1f6d33c203d8b4b))
* **ci:** helm charts copied to wrong dir in otf-charts repo ([94ab37b](https://github.com/bvgroup-co/otf/commit/94ab37ba3900dc9788beecb1aad37aaf8af85767))
* **ci:** skip redundant helm chart test ([8f90e9e](https://github.com/bvgroup-co/otf/commit/8f90e9e826d7827915d6d7f1c3a429572918aaf8))
* **ci:** support multi platform docker builds ([6af386f](https://github.com/bvgroup-co/otf/commit/6af386f9a580465133d6a5cbc6ffdfb01c557e73))
* copy clipboard notification clipped ([3703ad4](https://github.com/bvgroup-co/otf/commit/3703ad471c0205b9bfec386d9190bcc90ccac302))
* cross-platform build support ([#930](https://github.com/bvgroup-co/otf/issues/930)) ([d0d7a40](https://github.com/bvgroup-co/otf/commit/d0d7a40073e2d95e60902cbcb93dabb984b03b3d))
* **db:** deadlock exhausting max connections ([1d9d18e](https://github.com/bvgroup-co/otf/commit/1d9d18ed4f3c7e2198e94fef6ae6eb1db79f3646))
* **dev:** building docker images broken on non-linux devices ([#928](https://github.com/bvgroup-co/otf/issues/928)) ([5636d24](https://github.com/bvgroup-co/otf/commit/5636d2453ef2b9a6761dd28fd978c8085314e849))
* disable terraform interactive prompts ([272cabb](https://github.com/bvgroup-co/otf/commit/272cabb3a0f350e3cb3325944bc64aba08885f4c))
* docker-compose otfd healthcheck ([c553b58](https://github.com/bvgroup-co/otf/commit/c553b5895ff9bc8993991c872a31d74a63bc92f2))
* **dockerfile:** bump alpine version and upgrade base packages to fix critical CVE ([#882](https://github.com/bvgroup-co/otf/issues/882)) ([3e730d7](https://github.com/bvgroup-co/otf/commit/3e730d73468d32cb0e93a9207393de91a2bfe143))
* **dockerfile:** helm provider requires home dir ([86bf7b7](https://github.com/bvgroup-co/otf/commit/86bf7b7269843e11cc1454e350298c8d8afecbcf))
* **docs:** fix 404 links ([fb5dda0](https://github.com/bvgroup-co/otf/commit/fb5dda0a732c35ce64cad0c9e8716ed84b3e5c9d))
* **docs:** lists in forgeyo doc rendering items on same line ([db13b7a](https://github.com/bvgroup-co/otf/commit/db13b7a29896bafe145af6361f92466f11f052b3))
* don't add plan-only runs to workspace queue ([fc476c5](https://github.com/bvgroup-co/otf/commit/fc476c5e5b5ae7b9d939ad81b75180ecc2c3746d))
* don't append api. to github enterprise URLs ([b8c9b06](https://github.com/bvgroup-co/otf/commit/b8c9b062ab21abf7ec6111f484762094f2a5060d))
* don't assume public schema for postgres migrations ([e7510b0](https://github.com/bvgroup-co/otf/commit/e7510b0fabb487f76a6f5122bb6e2708fadb3a75))
* don't ignore custom hostname overrides for VCS providers ([#855](https://github.com/bvgroup-co/otf/issues/855)) ([c25801e](https://github.com/bvgroup-co/otf/commit/c25801e2ce4dc2289ee3d67bd0bf3f0cf62f8302))
* don't unnecessarily restart scheduler ([#689](https://github.com/bvgroup-co/otf/issues/689)) ([d240965](https://github.com/bvgroup-co/otf/commit/d24096536d06da30b035d846c7eb62537e2153a0))
* dont schedule already-scheduled runs at startup ([91cf7a1](https://github.com/bvgroup-co/otf/commit/91cf7a13a55a7bf19529072574c2c89b44e8525b))
* dont scrub sensitive variable values for agent ([#591](https://github.com/bvgroup-co/otf/issues/591)) ([a333ee6](https://github.com/bvgroup-co/otf/commit/a333ee6f7a04c234dbe5c34602a35f1095f35b32)), closes [#590](https://github.com/bvgroup-co/otf/issues/590)
* download terraform first to avoid test flakiness ([ea4f03b](https://github.com/bvgroup-co/otf/commit/ea4f03b0ecb65a35673f956e9919d001ff3e496c))
* drop organization event trigger ([869b82f](https://github.com/bvgroup-co/otf/commit/869b82f6d6056c6c9e9d6cbaaa44faf0d93766d3))
* emit agent-pool as a json:api relationship on workspace responses ([6c3bff8](https://github.com/bvgroup-co/otf/commit/6c3bff8763ce6d120f387d3654968b752e650c0d))
* enrich forgejo list repos errors ([9cdf6f2](https://github.com/bvgroup-co/otf/commit/9cdf6f23745183d24ae230639d7eb968f3a703b3))
* ensure otfd is resilient to database outages ([#932](https://github.com/bvgroup-co/otf/issues/932)) ([0c87654](https://github.com/bvgroup-co/otf/commit/0c87654667982b0a7cc60f2616f8b1563e119e95))
* ensure run timeout subsystem can handle db outage ([52a3fce](https://github.com/bvgroup-co/otf/commit/52a3fcec482cb1181a3edfe29a4adef0b2ceecc1))
* error 'schema: converter not found for integration.manifest' ([e53ebf2](https://github.com/bvgroup-co/otf/commit/e53ebf2e34288e437b11d69eba3e61324b21be22))
* event cleanup failing ([7a76322](https://github.com/bvgroup-co/otf/commit/7a76322d17f76de938fa344a96262fab3a5d7626))
* exclude websockets from etag middleware ([2d2567c](https://github.com/bvgroup-co/otf/commit/2d2567c9cc6763f3f3af841dbdab23651d9e7f47))
* fixed bug where proxy was ignored ([#609](https://github.com/bvgroup-co/otf/issues/609)) ([c1ee8d8](https://github.com/bvgroup-co/otf/commit/c1ee8d8ea53a05935c7d5d510054a6eaf588aa25))
* fixed defect with multiline tfvars not being escaped ([#631](https://github.com/bvgroup-co/otf/issues/631)) ([f35dffa](https://github.com/bvgroup-co/otf/commit/f35dffa97bec141491c1121fd10f39f5ca7893a1))
* force helm chart release ([16fb604](https://github.com/bvgroup-co/otf/commit/16fb604008e6cb84ad740eb40ed957ff1e1c3470))
* force otfd helm chart release ([a4f6e6c](https://github.com/bvgroup-co/otf/commit/a4f6e6cd363738255984b51e2013de8ce6495a54))
* gh app webhook panics when no gh app configured ([48a4b24](https://github.com/bvgroup-co/otf/commit/48a4b24f1c9de0505dc34282f7b35b424ba25de6))
* github app connected workspaces not sending status updates ([42e2ce7](https://github.com/bvgroup-co/otf/commit/42e2ce7ab039709a4c29b11001e642abac251be4))
* gitlab support ([#665](https://github.com/bvgroup-co/otf/issues/665)) ([eaf9b15](https://github.com/bvgroup-co/otf/commit/eaf9b15556159079d2770064f8d374f627615ea7)), closes [#651](https://github.com/bvgroup-co/otf/issues/651)
* handle tfe provider agent pool ID empty string gracefully ([48c7f45](https://github.com/bvgroup-co/otf/commit/48c7f45a3e2ac729a7ad8051d0dd3ed9629aa9a9))
* helm charts not being automatically updated upon release ([bb35d8d](https://github.com/bvgroup-co/otf/commit/bb35d8d9fce25f4536577271e00e4c5ed521eaed))
* improve performance of run metrics collector ([d421c16](https://github.com/bvgroup-co/otf/commit/d421c16756e1f2bd050b4ecb6cf97e43b57264e0))
* insufficient github perms triggering nil pointer err ([da51e5d](https://github.com/bvgroup-co/otf/commit/da51e5d6658697d8f1f2b8eae26cb5190bb62b16))
* **integration:** ensure text box is visible before focusing ([8d279ae](https://github.com/bvgroup-co/otf/commit/8d279aefdc8830b32cb262e8608ff394a2f62880))
* **integration:** prevent -32000 error ([39318f1](https://github.com/bvgroup-co/otf/commit/39318f1dd1966f621bfb930bf2f8cbee2c70266d))
* **integration:** wait for alpinejs to load ([346024e](https://github.com/bvgroup-co/otf/commit/346024ea87eedabfd086ea536c5ee79d19b531fa))
* jobs belonging to terminated runners should not restart allocator ([3b8e111](https://github.com/bvgroup-co/otf/commit/3b8e11169f7bc912fefa918d87c62c55754cc244))
* log create agent pool db errors ([ece6de7](https://github.com/bvgroup-co/otf/commit/ece6de7186d54bbeb390f8d6e7bf5c9e1c0eb543))
* log error if job files cannot be deleted ([9c3afcc](https://github.com/bvgroup-co/otf/commit/9c3afcca92dbaf68f1cfb4e34066ec75dd67e884))
* log max config size exceeded ([#663](https://github.com/bvgroup-co/otf/issues/663)) ([e196837](https://github.com/bvgroup-co/otf/commit/e196837fe88fc41b3b908537766db0b66530d281)), closes [#652](https://github.com/bvgroup-co/otf/issues/652)
* make goreleaser config valid for v2 ([0ed8d22](https://github.com/bvgroup-co/otf/commit/0ed8d22140570aefefdcabd3a16cdd46eefcebf4))
* make linting and tests pass ([ebc1e53](https://github.com/bvgroup-co/otf/commit/ebc1e53a9e00412e4db8467a71b299e86b5fb43e))
* make tern migration postgres 12 compat ([#695](https://github.com/bvgroup-co/otf/issues/695)) ([c662668](https://github.com/bvgroup-co/otf/commit/c6626686d03b8f6e2a8a34d8db1e692bf99f2b05))
* mike doc versioner flags have changed ([224081c](https://github.com/bvgroup-co/otf/commit/224081c5bbff6fd8ea0150365886573b457e25b3))
* module markdown rendering ([#831](https://github.com/bvgroup-co/otf/issues/831)) ([90700f1](https://github.com/bvgroup-co/otf/commit/90700f142a6ec6b81f82ad86ddc040b658a8dceb)), closes [#820](https://github.com/bvgroup-co/otf/issues/820)
* only log subsystem start when actually started ([a72fbd0](https://github.com/bvgroup-co/otf/commit/a72fbd0cc556f6f4bfbb85f79bef255512b40111))
* organization tokens ([#660](https://github.com/bvgroup-co/otf/issues/660)) ([be82c55](https://github.com/bvgroup-co/otf/commit/be82c559399a0b023aa63fe8f36e61d6fb9a9848))
* permit events larger than 8000 bytes ([e528d9a](https://github.com/bvgroup-co/otf/commit/e528d9ac37519f14f09df8080c1089b356c31d2b))
* pin version of gcp pub-sub emulator docker image ([8048e72](https://github.com/bvgroup-co/otf/commit/8048e720d3d7a99c1f244ba797f6276c1dd56938))
* prevent modules with no published versions from crashing otf ([#611](https://github.com/bvgroup-co/otf/issues/611)) ([84aa299](https://github.com/bvgroup-co/otf/commit/84aa2992856b87ad17b6dd582ee4528c01873b69))
* prevent subsystem failure from stopping otfd ([e5061b0](https://github.com/bvgroup-co/otf/commit/e5061b04bf051c9ad7f9e4ba7408cc3c4afa1a43))
* publish chart after release not before ([eceab7e](https://github.com/bvgroup-co/otf/commit/eceab7efbec1b82070cc02731f734e579d9cdd80))
* reduce websocket logging noise ([ed81049](https://github.com/bvgroup-co/otf/commit/ed81049f3e253bebbd7fad7e54c4fff1e0ed7c27))
* remove unnecessary string casting ([facada8](https://github.com/bvgroup-co/otf/commit/facada8c07bbe4b206b571fd7b2df2639d6b53af))
* remove unnecessary tool install make tasks ([acd9d6f](https://github.com/bvgroup-co/otf/commit/acd9d6f19ddd2ba9ceb9ffc6c564ed50571f15c2))
* report 409 when cancel or force cancel not allowed ([#693](https://github.com/bvgroup-co/otf/issues/693)) ([dbe5668](https://github.com/bvgroup-co/otf/commit/dbe5668cb8fab94eb510d64f2962f523efef8b46))
* report cfg error when starting run without cfg ([a39cc65](https://github.com/bvgroup-co/otf/commit/a39cc65f56faeee9dbb1379fc37bb272244d1195))
* restart spooler when broker terminates subscription ([#600](https://github.com/bvgroup-co/otf/issues/600)) ([ce41580](https://github.com/bvgroup-co/otf/commit/ce41580f1640c282ae89437eb377a8554232c412))
* resubscribe subsystems when their subscription is terminated ([#593](https://github.com/bvgroup-co/otf/issues/593)) ([3195e17](https://github.com/bvgroup-co/otf/commit/3195e17fe3e98ec418e0bbef6e4e46bc707a4f6c))
* retrieving state outputs only requires read role ([#603](https://github.com/bvgroup-co/otf/issues/603)) ([25c4a99](https://github.com/bvgroup-co/otf/commit/25c4a992fac150aca02a51c5d655d6364d159dca))
* run error tests ([be7d10d](https://github.com/bvgroup-co/otf/commit/be7d10d47dcadd6f6cc544b778634d51e99a06f1))
* run release workflow on main ([479f475](https://github.com/bvgroup-co/otf/commit/479f47549b8585cb4cce64d7c0d2d659c3bed61b))
* runner job capacity exceeded again ([f362c6d](https://github.com/bvgroup-co/otf/commit/f362c6da10f5914289043125be8b0dac203c3680))
* runner unable to re-register ([#707](https://github.com/bvgroup-co/otf/issues/707)) ([41f5669](https://github.com/bvgroup-co/otf/commit/41f5669ef362dc42507b8a8c61c074e022c9bb02))
* runner wasn't sending final status update ([83d768d](https://github.com/bvgroup-co/otf/commit/83d768d762ccbb20da0e1fc7a64c863c8875e7bf))
* **runner:** canceling non-running jobs causes deadlock ([bad9fce](https://github.com/bvgroup-co/otf/commit/bad9fce0f310f587492c5e2e0d24d6a51aafcbc3))
* **scheduler:** runs stuck in pending state ([#722](https://github.com/bvgroup-co/otf/issues/722)) ([3d4306d](https://github.com/bvgroup-co/otf/commit/3d4306d12d84f6235e4a5204bedf680c46756939))
* set module status ([#586](https://github.com/bvgroup-co/otf/issues/586)) ([8141c6e](https://github.com/bvgroup-co/otf/commit/8141c6ed2da175700405cb5c5f34658660cb68e7))
* skip reporting runs created via API ([#622](https://github.com/bvgroup-co/otf/issues/622)) ([5d4527b](https://github.com/bvgroup-co/otf/commit/5d4527b52573c8600d49ed149ea16bdb7f57f141)), closes [#618](https://github.com/bvgroup-co/otf/issues/618)
* start subsystems in order to eliminate flaky tests ([63ab291](https://github.com/bvgroup-co/otf/commit/63ab291ccde9af7d4bffc31155cd03fa3115ba26))
* support earliest supported version of postgres (v13) ([649f499](https://github.com/bvgroup-co/otf/commit/649f499fd4f078c943d15427eb7c2da0a564cf7c))
* support subgroups in GitLab vcs provider. ([#920](https://github.com/bvgroup-co/otf/issues/920)) ([14c97ef](https://github.com/bvgroup-co/otf/commit/14c97ef5146d720201d805386e2d53fe2702c79f))
* swap out bitnami postgres helm chart ([539cd9c](https://github.com/bvgroup-co/otf/commit/539cd9c8c8fe9f074350c467a3430aee74dfb510))
* sync layout templ code ([3cf0505](https://github.com/bvgroup-co/otf/commit/3cf0505816df8a5d475488d06ecf290c70856885))
* tags regex empty string and non-zero trigger patterns should not throw error ([#874](https://github.com/bvgroup-co/otf/issues/874)) ([741fc3b](https://github.com/bvgroup-co/otf/commit/741fc3bffbdebdd5bab4e9d649f9a48cd398811f))
* **tests:** broken runner registration test ([36ac6a7](https://github.com/bvgroup-co/otf/commit/36ac6a77c85f9295bc3675190b050cbceb145fbd))
* **tests:** disable flaky terraform login redirect check ([4f3f6c0](https://github.com/bvgroup-co/otf/commit/4f3f6c0c1e310a6d5f2142444c09dd09151fe5ca))
* **tests:** don't use singleton http handler ([eae2149](https://github.com/bvgroup-co/otf/commit/eae2149e2e2a90c4b044118c4b38a90764245a7f))
* **tests:** exit dangling goroutine at end of test ([890ca50](https://github.com/bvgroup-co/otf/commit/890ca50b091d4751985e2810044e5c89218daa76))
* **tests:** IAP test breaks if enabled ([fce6f46](https://github.com/bvgroup-co/otf/commit/fce6f46654992e28ddb2f4b543914409d85a72e8))
* **tests:** screenshots not being archived upon failure ([3ff867e](https://github.com/bvgroup-co/otf/commit/3ff867e119b83705d98c7d005f61b2f368838751))
* **tests:** suppress tls handshake errors ([d3c42ab](https://github.com/bvgroup-co/otf/commit/d3c42ab0d022265767c2e140111cfe6266f5866e))
* **tests:** terraform init test broke with new default version ([fe24f22](https://github.com/bvgroup-co/otf/commit/fe24f22f8075b00395ab06730802f125a1a345e4))
* **tests:** use check instead of click for flaky tests ([e458abe](https://github.com/bvgroup-co/otf/commit/e458abe82b789d303ca9f9866756e3c2168ee205))
* **tests:** use workaround for flaky checkbox clicks ([d8dc659](https://github.com/bvgroup-co/otf/commit/d8dc659cb77bb0a015911aaddaaa85a84fd4d2af))
* **tests:** using test ctx breaks integration tests ([5cbffc3](https://github.com/bvgroup-co/otf/commit/5cbffc30c3f8ceb57bb38c72656598a239c95ad5))
* tfe_outputs resource ([#599](https://github.com/bvgroup-co/otf/issues/599)) ([89de01d](https://github.com/bvgroup-co/otf/commit/89de01d48c1878982a7f56e436c8904bd3bc0a09)), closes [#595](https://github.com/bvgroup-co/otf/issues/595)
* UI crashes when forgejo VCS provider fails to connect ([#838](https://github.com/bvgroup-co/otf/issues/838)) ([d4ba67e](https://github.com/bvgroup-co/otf/commit/d4ba67e5958ab33e5d87c342f6151e2116473f16)), closes [#837](https://github.com/bvgroup-co/otf/issues/837)
* **ui:** allow variable to be updated from hcl to non-hcl ([ac0ff5a](https://github.com/bvgroup-co/otf/commit/ac0ff5ae654c18525632d41085fce34c8cc36711))
* **ui:** appropriate colours for run statuses ([#732](https://github.com/bvgroup-co/otf/issues/732)) ([d217736](https://github.com/bvgroup-co/otf/commit/d2177361cdb9fbcc157c43a4ffd5fda4befa52ad)), closes [#730](https://github.com/bvgroup-co/otf/issues/730)
* **ui:** auto show force cancel button after cool off period ([72b74ca](https://github.com/bvgroup-co/otf/commit/72b74caa3a636e7069ebf86dc1773d7c726238a3))
* **ui:** bad db query broke runner listing ([d86705c](https://github.com/bvgroup-co/otf/commit/d86705c11a6182462b6a3f2303a6bcfe73c752c4))
* **ui:** broken workspace lock widget for non-site-admins ([37c5d1d](https://github.com/bvgroup-co/otf/commit/37c5d1d04718922f8f18549c66acd20704fa1226))
* **ui:** cancel run button sometimes doesn't do anything ([d29a0ef](https://github.com/bvgroup-co/otf/commit/d29a0ef7ea55abf4060b190365c799ea3cc1c159))
* **ui:** cannot unassign team permissions ([b4415b4](https://github.com/bvgroup-co/otf/commit/b4415b401c0a1367ed4d888c4008936f9c10727e))
* **ui:** don't use symlink for logo ([30c3d37](https://github.com/bvgroup-co/otf/commit/30c3d37131e5b0b4511652a341fc5fe15446dbcd))
* **ui:** edit variable set variable link 404 ([5eed13a](https://github.com/bvgroup-co/otf/commit/5eed13a8dbcee53a8ec18560834e2b1a8f48c791))
* **ui:** express durations &gt; 24h as days not hours ([a37f826](https://github.com/bvgroup-co/otf/commit/a37f826e7222b9493bc60fc2765a2b56edaec125))
* **ui:** hide sensitive outputs on the workspace page ([#810](https://github.com/bvgroup-co/otf/issues/810)) ([87dcc61](https://github.com/bvgroup-co/otf/commit/87dcc61bb2e920a1c074578c82a3fc7aacf8a529))
* **ui:** make page size selector fully visible when set to 100 ([5ec4f84](https://github.com/bvgroup-co/otf/commit/5ec4f84132ceef293452d3ed32d1fb5c5e906674))
* **ui:** nil panic when two workspace variables have same key ([4a6ed58](https://github.com/bvgroup-co/otf/commit/4a6ed58624df505ab96ec619efce667648cd285c))
* **ui:** no delete button for variable set variable ([88449cd](https://github.com/bvgroup-co/otf/commit/88449cd0a6c8c6f01b8d02af613ed88e7e00a905))
* **ui:** page metadata info hard to see in dark mode ([1ac8cd5](https://github.com/bvgroup-co/otf/commit/1ac8cd5a872729b7ce4b227947c3f6c65699f7bc))
* **ui:** pagination broken on some pages ([cc6d970](https://github.com/bvgroup-co/otf/commit/cc6d970197a8ee80a99aa8ac5ebc1c0fba9f1e2a))
* **ui:** path to daisyui.js in tailwind config is wrong ([efe55a1](https://github.com/bvgroup-co/otf/commit/efe55a177f813a42fd8916a59602ce32ab3cccb2))
* **ui:** polling table not sending page number param ([7591827](https://github.com/bvgroup-co/otf/commit/7591827fee43539c1d72eb373899607172abda83))
* **ui:** push docs to remote gh-pages branch ([5b3e3f4](https://github.com/bvgroup-co/otf/commit/5b3e3f4e3034aeaba6cb27855f2314c12b964112))
* **ui:** remove carriage returns from textarea inputs ([98898d4](https://github.com/bvgroup-co/otf/commit/98898d49654ebcde0f1fc82d05685c0efb4b374c))
* **ui:** remove extra semicolons ([#818](https://github.com/bvgroup-co/otf/issues/818)) ([1ee991c](https://github.com/bvgroup-co/otf/commit/1ee991cbbd20bb39394f2d4375f9249a9292328c)), closes [#817](https://github.com/bvgroup-co/otf/issues/817)
* **ui:** remove spaces from change summary ([45f2329](https://github.com/bvgroup-co/otf/commit/45f232931a98eb349bf313eeea888d67fbf689ef))
* **ui:** remove undefined css classes ([daf6096](https://github.com/bvgroup-co/otf/commit/daf60965418061ff4374689613bc8c2a2ce8efe8))
* **ui:** send user to vcs settings after connecting workspace ([337d3af](https://github.com/bvgroup-co/otf/commit/337d3afd7ff5aa940a25bacafcbdee178c743ad0))
* **ui:** set max width ([cceb0d3](https://github.com/bvgroup-co/otf/commit/cceb0d3631404659af8e3b0aac5ce415816a0e1c))
* **ui:** setting `--default-engine=tofu` would remove terraform as alternative ([#941](https://github.com/bvgroup-co/otf/issues/941)) ([b33a9c6](https://github.com/bvgroup-co/otf/commit/b33a9c627ea691e7e1384d128c74d171cdec4a31))
* **ui:** several pages missing highlighted menu item ([03babff](https://github.com/bvgroup-co/otf/commit/03babff1dfffda4220bf49ab1f09517bb252a05c))
* **ui:** some things hard to see in dark mode ([c4aece4](https://github.com/bvgroup-co/otf/commit/c4aece40fab20939b6b7af078fb498237b3508f7))
* **ui:** stale statuses on run page ([c4f3a65](https://github.com/bvgroup-co/otf/commit/c4f3a65a8867258c2125ef07db6cb169b13c80ea))
* **ui:** unable to toggle pull request speculative plans ([e122892](https://github.com/bvgroup-co/otf/commit/e1228924a9c2b9cbddd10154ae4d704a9502d246))
* **ui:** unmangle ssh private key from textarea ([#914](https://github.com/bvgroup-co/otf/issues/914)) ([73fb827](https://github.com/bvgroup-co/otf/commit/73fb827494702c8d34569c90bdd4aa5f2aa906c3)), closes [#913](https://github.com/bvgroup-co/otf/issues/913)
* **ui:** unresponsive agent pool page ([#701](https://github.com/bvgroup-co/otf/issues/701)) ([c0853f5](https://github.com/bvgroup-co/otf/commit/c0853f51f8ba359e6f96fdd43ccb089ede645598)), closes [#698](https://github.com/bvgroup-co/otf/issues/698) [#661](https://github.com/bvgroup-co/otf/issues/661)
* **ui:** use brighter colors in logo ([e824e6f](https://github.com/bvgroup-co/otf/commit/e824e6f7674a8e7f1713687352a144a137f301e5))
* **ui:** various UI fixes ([a368efe](https://github.com/bvgroup-co/otf/commit/a368efe138fd37ed2dea46c4ff67b2df74ad403c))
* **ui:** various VCS fixes ([#797](https://github.com/bvgroup-co/otf/issues/797)) ([99905ce](https://github.com/bvgroup-co/otf/commit/99905ceb98fe94d14a0c333665a1d3b97a6fbca0))
* **ui:** workspace listing returning 500 error ([6eb89f4](https://github.com/bvgroup-co/otf/commit/6eb89f48c73337426feb1d704a60f4471cf85942))
* update helm chart lock file ([b5aa360](https://github.com/bvgroup-co/otf/commit/b5aa360a255d5d2b7c2f378124bd2b7c1e0d4fd6))
* use base58 alphabet for resource IDs ([#680](https://github.com/bvgroup-co/otf/issues/680)) ([1e7d7a2](https://github.com/bvgroup-co/otf/commit/1e7d7a2b2c350c17c29fb49ae0dfbbeb31b2942d))
* use generic update func to eliminate tx propagation failure ([#720](https://github.com/bvgroup-co/otf/issues/720)) ([900fbe7](https://github.com/bvgroup-co/otf/commit/900fbe7d17aef0a7df27c6cc25cfa72a13cd648e))
* variable set variables API ([#589](https://github.com/bvgroup-co/otf/issues/589)) ([8e29da1](https://github.com/bvgroup-co/otf/commit/8e29da191122103dd76eca876c37b419e106e630)), closes [#588](https://github.com/bvgroup-co/otf/issues/588)
* various agent pool and job bugs ([#659](https://github.com/bvgroup-co/otf/issues/659)) ([ed9b1fd](https://github.com/bvgroup-co/otf/commit/ed9b1fdb6485f8ad16f60df19021273376a3bdd4))
* wait for listener to start first ([b49fdb7](https://github.com/bvgroup-co/otf/commit/b49fdb73bd7ba970e65e917594254fd881a61218))
* when copying an ID, copy only the ID, not the &lt;span&gt; tag ([#790](https://github.com/bvgroup-co/otf/issues/790)) ([1eb4268](https://github.com/bvgroup-co/otf/commit/1eb4268ef05cd3e76c5031b700e1a12817968135))
* workspace sql cascade set null on user or run deletion ([687c35c](https://github.com/bvgroup-co/otf/commit/687c35c37cacc499f8b42234083ad1e6fe4b00ec))
* wrong math operator causes logs to be prematurely chunked ([9fcd312](https://github.com/bvgroup-co/otf/commit/9fcd31286bf387b5923661945802906d5b9da3ad))


### Miscellaneous

* add more logging and error context ([a7adab5](https://github.com/bvgroup-co/otf/commit/a7adab5013f8054b82f821d2485e3c32c185394f))
* add note re cloud block to allow CLI apply ([4f03544](https://github.com/bvgroup-co/otf/commit/4f03544275ac884073be221f5f8a5f88ada0552d))
* **agent:** add further comment on setting k8s server url ([7c48284](https://github.com/bvgroup-co/otf/commit/7c482845d4f5f17ca3ea450378ff6670ed2638c7))
* archive browser traces in github actions ([0310143](https://github.com/bvgroup-co/otf/commit/0310143e7a2e6e49e4929b63e572295a7964b9bc))
* bump daisyui version ([dfd3904](https://github.com/bvgroup-co/otf/commit/dfd3904bffa72a4347cd9c054c32e43bc377de12))
* bump dependencies ([0d251ed](https://github.com/bvgroup-co/otf/commit/0d251ed5d8bb498131d1539919631b8f6937708b))
* bump dependencies ([6168747](https://github.com/bvgroup-co/otf/commit/616874790518d905ddda66c6b585bedb23780c37))
* bump everything ([73a0f6a](https://github.com/bvgroup-co/otf/commit/73a0f6ad2ca3113263ba29036705e83000c8b6c5))
* bump go ([5663eab](https://github.com/bvgroup-co/otf/commit/5663eab55cf22f5d9fe9f8a29c6df9d2908ecb20))
* bump helm charts with app version v0.5.13 ([bdf950f](https://github.com/bvgroup-co/otf/commit/bdf950fddbed894c2fe0ebee16e96ac9a6e6ae1c))
* bump helm charts with app version v0.5.14 ([4b34e68](https://github.com/bvgroup-co/otf/commit/4b34e68fe4edd1dbd663dff3fbab88c2f7f7f4ed))
* bump helm charts with app version v0.5.15 ([a370a82](https://github.com/bvgroup-co/otf/commit/a370a823583ff0e519618175619a5e2a09450a3d))
* bump helm charts with app version v0.5.16 ([ee9cfe0](https://github.com/bvgroup-co/otf/commit/ee9cfe023f815b89325ff33c6e4828af51a5511e))
* bump helm charts with app version v0.5.17 ([ccb3d14](https://github.com/bvgroup-co/otf/commit/ccb3d142964da0ffaed400b35c7c7c46b561750d))
* bump helm charts with app version v0.5.18 ([b44b1c4](https://github.com/bvgroup-co/otf/commit/b44b1c4d2a866f1111c144260e5dae9e803a53cb))
* bump helm charts with app version v0.5.19 ([edf49d7](https://github.com/bvgroup-co/otf/commit/edf49d7e13827639033455b46cca74ad669a47fd))
* bump helm charts with app version v0.5.21 ([34e1ba6](https://github.com/bvgroup-co/otf/commit/34e1ba62253f9f8f1072b0eb3b1c534ebb90b708))
* bump helm charts with app version v0.5.22 ([f1a2e00](https://github.com/bvgroup-co/otf/commit/f1a2e000b145d418bcf45d0e93d5cd4ab8cd1977))
* bump helm charts with app version v0.5.23 ([5f0d0ed](https://github.com/bvgroup-co/otf/commit/5f0d0ed830653c5294a5698f04118ee3dfc052ea))
* bump helm charts with app version v0.5.24 ([2c860c9](https://github.com/bvgroup-co/otf/commit/2c860c922d532b89acd1109aa660c8be69551b30))
* bump js libs ([d90c1a4](https://github.com/bvgroup-co/otf/commit/d90c1a4ae01f26ded080ac83d14d157c5dd4519f))
* bump playwright ([25313e2](https://github.com/bvgroup-co/otf/commit/25313e2e09fea51e22553ad06d43952cce75e8ad))
* bump playwright ([af87baa](https://github.com/bvgroup-co/otf/commit/af87baa8054b470ae9c0fcc00fb3d604440c24a6))
* bump playwright version ([94a474e](https://github.com/bvgroup-co/otf/commit/94a474e8040dd65be8139570f50d52a6c6fffb15))
* bump sqlc version ([96007b3](https://github.com/bvgroup-co/otf/commit/96007b331fa64064fac6f4421f6e1f00e626b2ac))
* bump templ ([dd8d027](https://github.com/bvgroup-co/otf/commit/dd8d027b6cdfae7a70afce8fef5ae22cc9361972))
* bump templ version ([15768e0](https://github.com/bvgroup-co/otf/commit/15768e0992164e28d86c2a8d3b5ee6266f23787c))
* bump templ version ([cbd6f3c](https://github.com/bvgroup-co/otf/commit/cbd6f3c329a3edfca15c9d8bea266700991a4b15))
* bump to go1.26 and adopt new func ([25c12ec](https://github.com/bvgroup-co/otf/commit/25c12ec064046154f137d7d2381a1a74082df3ec))
* bump vuln go-slug dep ([927c8b9](https://github.com/bvgroup-co/otf/commit/927c8b9a830210b771d958bce600779fd051ec35))
* change default engine notice wording ([620672f](https://github.com/bvgroup-co/otf/commit/620672fdabfa5a77095c96d6b8e21be35b49354f))
* check for differences in CI ([c634586](https://github.com/bvgroup-co/otf/commit/c63458677a0942b86963c739709bfeb94d55a568))
* **ci:** update helm-docs command ([8c6a157](https://github.com/bvgroup-co/otf/commit/8c6a1574dd7de7ddabdd2fbe895891c339d38f57))
* debug GHA failing tests ([c7ef8ce](https://github.com/bvgroup-co/otf/commit/c7ef8ce261386e8dacae4619aa7fa165019a58f8))
* **dev:** make templ watch mode less verbose ([d15c246](https://github.com/bvgroup-co/otf/commit/d15c24646be2a38e7eaa9add4cdf43b2d517ff3e))
* **docs:** remove redundant flag --dev-mode ([ac1d401](https://github.com/bvgroup-co/otf/commit/ac1d40159b1a0b5a821d3d12952b1456ba3eea7e))
* **docs:** tweak a couple of pages ([2904f91](https://github.com/bvgroup-co/otf/commit/2904f910571729b4d844201febbec7a39ab21c93))
* document dynamic credentials test setup ([efecef2](https://github.com/bvgroup-co/otf/commit/efecef20d7b5a8539ce5b77c83751a9cc9ae1cef))
* document some more flags ([e2cc4f2](https://github.com/bvgroup-co/otf/commit/e2cc4f271956e737571778de81f8e4d926fe3e55))
* document tofu support ([9b1fe1b](https://github.com/bvgroup-co/otf/commit/9b1fe1bff09ca3930ff41f43412756a6079fd805))
* don't embed types in service options ([bab751c](https://github.com/bvgroup-co/otf/commit/bab751cfad8d433505ea6aaa2a9e34c7d0a4a90d))
* don't raise error unnecessarilyi ([720b93b](https://github.com/bvgroup-co/otf/commit/720b93b6a8e9d9e35eacefd91889d91753a64591))
* drop bubblewrap support ([eb747d1](https://github.com/bvgroup-co/otf/commit/eb747d16a8a2dd4dd661a8b72647d8ba717a0276))
* fix linting errors ([e7a75a9](https://github.com/bvgroup-co/otf/commit/e7a75a99cb128904f8fc7eff54d2b291e2cde5f8))
* fix(lint): resolve issues raised with latest staticcheck ([39565b9](https://github.com/bvgroup-co/otf/commit/39565b9406d83760ab1f3282f76d4537b35bb98f))
* introduce resource.ID interface ([454209f](https://github.com/bvgroup-co/otf/commit/454209fcdc34fe63bdd2150746c53d674fa21de5))
* **master:** release 0.1.10 ([#587](https://github.com/bvgroup-co/otf/issues/587)) ([fc64a73](https://github.com/bvgroup-co/otf/commit/fc64a7350a81555f44163ea83b6ca0ddb9493d0a))
* **master:** release 0.1.11 ([#592](https://github.com/bvgroup-co/otf/issues/592)) ([3596ad9](https://github.com/bvgroup-co/otf/commit/3596ad95bf5a4b8cebf55b5c1d9087a0772f26c1))
* **master:** release 0.1.12 ([#598](https://github.com/bvgroup-co/otf/issues/598)) ([cc057e8](https://github.com/bvgroup-co/otf/commit/cc057e820f9767d05cea737847392db67bfd4307))
* **master:** release 0.1.13 ([#602](https://github.com/bvgroup-co/otf/issues/602)) ([cb025ed](https://github.com/bvgroup-co/otf/commit/cb025ed248c7126d158833ccc4bbf4202f01bb92))
* **master:** release 0.1.14 ([#606](https://github.com/bvgroup-co/otf/issues/606)) ([abb7f0f](https://github.com/bvgroup-co/otf/commit/abb7f0f6d749ecf8219547944104503e2faebc6b))
* **master:** release 0.1.15 ([#629](https://github.com/bvgroup-co/otf/issues/629)) ([9085f5b](https://github.com/bvgroup-co/otf/commit/9085f5bc6d91e6d39430d2da819572a0cd9bcbaf))
* **master:** release 0.1.16 ([#632](https://github.com/bvgroup-co/otf/issues/632)) ([899a371](https://github.com/bvgroup-co/otf/commit/899a37145770100010a07101a083ce2f2f25cfa4))
* **master:** release 0.1.17 ([#634](https://github.com/bvgroup-co/otf/issues/634)) ([bf1b3d4](https://github.com/bvgroup-co/otf/commit/bf1b3d4a6585788f71be09e744ecc70d232d2aae))
* **master:** release 0.1.18 ([#637](https://github.com/bvgroup-co/otf/issues/637)) ([dc7c7cc](https://github.com/bvgroup-co/otf/commit/dc7c7ccf82314e3f9d8cb6b084cf9cce235d8ee8))
* **master:** release 0.2.0 ([#644](https://github.com/bvgroup-co/otf/issues/644)) ([a0c5b7a](https://github.com/bvgroup-co/otf/commit/a0c5b7a91360c1d3e67ebdff925992826ce62d1a))
* **master:** release 0.2.1 ([#657](https://github.com/bvgroup-co/otf/issues/657)) ([2915697](https://github.com/bvgroup-co/otf/commit/291569786da3613f5864e52afd438f130e19a9a9))
* **master:** release 0.2.2 ([#664](https://github.com/bvgroup-co/otf/issues/664)) ([3c62ff1](https://github.com/bvgroup-co/otf/commit/3c62ff16ccde81fb8e192d7fd678882f44210e1b))
* **master:** release 0.2.3 ([#667](https://github.com/bvgroup-co/otf/issues/667)) ([b518d44](https://github.com/bvgroup-co/otf/commit/b518d44f2b200261204faa7904d1610360bdc369))
* **master:** release 0.2.4 ([#674](https://github.com/bvgroup-co/otf/issues/674)) ([a2d4583](https://github.com/bvgroup-co/otf/commit/a2d4583fc314f8f77b14bc604aca6ae36b21d4ec))
* **master:** release 0.3.0 ([#682](https://github.com/bvgroup-co/otf/issues/682)) ([59d22ba](https://github.com/bvgroup-co/otf/commit/59d22baa29902cac265fe07ff6bb572d8b3efb6b))
* **master:** release 0.3.1 ([#691](https://github.com/bvgroup-co/otf/issues/691)) ([7b24720](https://github.com/bvgroup-co/otf/commit/7b24720f8c76af424ba9cce52d652afe562437a2))
* **master:** release 0.3.10 ([#721](https://github.com/bvgroup-co/otf/issues/721)) ([3145733](https://github.com/bvgroup-co/otf/commit/31457332d593bc00af5c50652b3870c337100b4e))
* **master:** release 0.3.11 ([#724](https://github.com/bvgroup-co/otf/issues/724)) ([6ffab31](https://github.com/bvgroup-co/otf/commit/6ffab31c7208f7dcb716621771aa08a0517aa4cb))
* **master:** release 0.3.12 ([#725](https://github.com/bvgroup-co/otf/issues/725)) ([0e2f958](https://github.com/bvgroup-co/otf/commit/0e2f958d7b477ae49db1b25b4608cc3b391cf127))
* **master:** release 0.3.13 ([#726](https://github.com/bvgroup-co/otf/issues/726)) ([2f0bf4d](https://github.com/bvgroup-co/otf/commit/2f0bf4d38c9a70be25ecd701802763cd2ad59302))
* **master:** release 0.3.14 ([#728](https://github.com/bvgroup-co/otf/issues/728)) ([769c635](https://github.com/bvgroup-co/otf/commit/769c6355d42e8d7658a0fe754711940f7b6daeb9))
* **master:** release 0.3.15 ([#738](https://github.com/bvgroup-co/otf/issues/738)) ([d433ee2](https://github.com/bvgroup-co/otf/commit/d433ee2260fbe742d6cec2a2fcb38c16d3a2f75b))
* **master:** release 0.3.16 ([#742](https://github.com/bvgroup-co/otf/issues/742)) ([06272c2](https://github.com/bvgroup-co/otf/commit/06272c2112e8100eb0c34ca0f29e52edede3c0a5))
* **master:** release 0.3.17 ([#744](https://github.com/bvgroup-co/otf/issues/744)) ([8316825](https://github.com/bvgroup-co/otf/commit/831682507724c87e13428086214a76575f3fbac3))
* **master:** release 0.3.18 ([#755](https://github.com/bvgroup-co/otf/issues/755)) ([00a0dcc](https://github.com/bvgroup-co/otf/commit/00a0dcc10f350639229dab047155c2114096252c))
* **master:** release 0.3.19 ([#759](https://github.com/bvgroup-co/otf/issues/759)) ([b460ada](https://github.com/bvgroup-co/otf/commit/b460adae7cf63d950dc802e7f8541d5a3fb2b5d0))
* **master:** release 0.3.2 ([#692](https://github.com/bvgroup-co/otf/issues/692)) ([0d9269f](https://github.com/bvgroup-co/otf/commit/0d9269f98ed769e48d6ca943bd4e78411253ba6a))
* **master:** release 0.3.20 ([#761](https://github.com/bvgroup-co/otf/issues/761)) ([8692710](https://github.com/bvgroup-co/otf/commit/8692710bf3414a3cb88713523d332aa31efd5162))
* **master:** release 0.3.21 ([#765](https://github.com/bvgroup-co/otf/issues/765)) ([215abdf](https://github.com/bvgroup-co/otf/commit/215abdf73810ae0d96c88e99879600032e4d0e40))
* **master:** release 0.3.22 ([#767](https://github.com/bvgroup-co/otf/issues/767)) ([ddc5d05](https://github.com/bvgroup-co/otf/commit/ddc5d0542e03721f614045dc9c191574eb3c350e))
* **master:** release 0.3.23 ([#779](https://github.com/bvgroup-co/otf/issues/779)) ([eb61c7f](https://github.com/bvgroup-co/otf/commit/eb61c7fa2cc9e2e84bd294e81eac086928ebbc3f))
* **master:** release 0.3.24 ([#788](https://github.com/bvgroup-co/otf/issues/788)) ([e34a975](https://github.com/bvgroup-co/otf/commit/e34a9751b0661e69daf985f3be7b7faa9cc39dfa))
* **master:** release 0.3.25 ([#799](https://github.com/bvgroup-co/otf/issues/799)) ([a1cd3c8](https://github.com/bvgroup-co/otf/commit/a1cd3c845fd327555dc30349fa6019da2bc62825))
* **master:** release 0.3.26 ([#800](https://github.com/bvgroup-co/otf/issues/800)) ([3a448ef](https://github.com/bvgroup-co/otf/commit/3a448ef89d02acfc27244d64dbf50d7db81405da))
* **master:** release 0.3.27 ([#805](https://github.com/bvgroup-co/otf/issues/805)) ([fb2c508](https://github.com/bvgroup-co/otf/commit/fb2c50835fb194fe58b4a8dd1ad67ebffb515581))
* **master:** release 0.3.3 ([#694](https://github.com/bvgroup-co/otf/issues/694)) ([45f115e](https://github.com/bvgroup-co/otf/commit/45f115e56815ebb3de0e390f30f2436129fd3b86))
* **master:** release 0.3.4 ([#700](https://github.com/bvgroup-co/otf/issues/700)) ([c8cdd4a](https://github.com/bvgroup-co/otf/commit/c8cdd4a261c90c723bcdd81448707f9b0dbadccb))
* **master:** release 0.3.5 ([#702](https://github.com/bvgroup-co/otf/issues/702)) ([1035d18](https://github.com/bvgroup-co/otf/commit/1035d18ae58ae413f7c57ada40d983f6455690e7))
* **master:** release 0.3.6 ([#706](https://github.com/bvgroup-co/otf/issues/706)) ([3511d5f](https://github.com/bvgroup-co/otf/commit/3511d5f66209fa767de0d841ccfc3d47da155551))
* **master:** release 0.3.7 ([#712](https://github.com/bvgroup-co/otf/issues/712)) ([231de97](https://github.com/bvgroup-co/otf/commit/231de974a89b8dece68a8b4afd0aa1fc7a3d74fd))
* **master:** release 0.3.8 ([#718](https://github.com/bvgroup-co/otf/issues/718)) ([012f928](https://github.com/bvgroup-co/otf/commit/012f928837242a079e3b282014824865684982cc))
* **master:** release 0.3.9 ([#719](https://github.com/bvgroup-co/otf/issues/719)) ([95d211e](https://github.com/bvgroup-co/otf/commit/95d211e9fa4d67994e87423c64a8a057821d7ed3))
* **master:** release 0.4.0 ([#808](https://github.com/bvgroup-co/otf/issues/808)) ([2519a64](https://github.com/bvgroup-co/otf/commit/2519a6483da7c4109c90e774eff127de02c6cf06))
* **master:** release 0.4.1 ([#819](https://github.com/bvgroup-co/otf/issues/819)) ([b1d5200](https://github.com/bvgroup-co/otf/commit/b1d5200cb2ad95aa3746bafe1ea404a29745bad6))
* **master:** release 0.4.10 ([#852](https://github.com/bvgroup-co/otf/issues/852)) ([71750bb](https://github.com/bvgroup-co/otf/commit/71750bb8fc420b6770a0ddc8e4935127713a7ad7))
* **master:** release 0.4.2 ([#826](https://github.com/bvgroup-co/otf/issues/826)) ([ded2e2f](https://github.com/bvgroup-co/otf/commit/ded2e2fa0231f103aa905b3ec777b07a5266f02b))
* **master:** release 0.4.3 ([#829](https://github.com/bvgroup-co/otf/issues/829)) ([12cf37c](https://github.com/bvgroup-co/otf/commit/12cf37ccd128ad0a6f1164cb978d505e86bc7b1e))
* **master:** release 0.4.4 ([#830](https://github.com/bvgroup-co/otf/issues/830)) ([297b7df](https://github.com/bvgroup-co/otf/commit/297b7dfe9e1937684a9e01434c5356356ba4f213))
* **master:** release 0.4.5 ([#832](https://github.com/bvgroup-co/otf/issues/832)) ([0efce3c](https://github.com/bvgroup-co/otf/commit/0efce3c6e6777ef7c885834213bfaf588751faa1))
* **master:** release 0.4.6 ([#833](https://github.com/bvgroup-co/otf/issues/833)) ([7513f7a](https://github.com/bvgroup-co/otf/commit/7513f7a49ed36de70e5a758ba0e53efac1b10d70))
* **master:** release 0.4.7 ([#835](https://github.com/bvgroup-co/otf/issues/835)) ([07ec92f](https://github.com/bvgroup-co/otf/commit/07ec92fbf001b352e9dde5572f5065e2e0c8ced8))
* **master:** release 0.4.8 ([#840](https://github.com/bvgroup-co/otf/issues/840)) ([6041b9d](https://github.com/bvgroup-co/otf/commit/6041b9dc9d3ec3e348cd960459a43a970610bce2))
* **master:** release 0.4.9 ([#846](https://github.com/bvgroup-co/otf/issues/846)) ([eb89d6a](https://github.com/bvgroup-co/otf/commit/eb89d6a5a4e1b3dc970a25644a3988cc2c374838))
* **master:** release 0.5.0 ([#856](https://github.com/bvgroup-co/otf/issues/856)) ([7c26695](https://github.com/bvgroup-co/otf/commit/7c2669573fb3c3cdaf2076509f86f80a11ec8290))
* **master:** release 0.5.1 ([#861](https://github.com/bvgroup-co/otf/issues/861)) ([712ebc9](https://github.com/bvgroup-co/otf/commit/712ebc9c59cabe4a71b43e191df77af5e5559736))
* **master:** release 0.5.10 ([#888](https://github.com/bvgroup-co/otf/issues/888)) ([15bb8ed](https://github.com/bvgroup-co/otf/commit/15bb8edbc83b5928ef92a992d2feb86cd0810606))
* **master:** release 0.5.11 ([#890](https://github.com/bvgroup-co/otf/issues/890)) ([5816fba](https://github.com/bvgroup-co/otf/commit/5816fba7c4c8e3ef3586875c5c25a659dd31c931))
* **master:** release 0.5.12 ([#891](https://github.com/bvgroup-co/otf/issues/891)) ([0760243](https://github.com/bvgroup-co/otf/commit/0760243be2032ec21381eb195efb7ed65b4ce60b))
* **master:** release 0.5.13 ([#893](https://github.com/bvgroup-co/otf/issues/893)) ([ffbc932](https://github.com/bvgroup-co/otf/commit/ffbc932a8de9da4e591e7bb4e8304f0374694941))
* **master:** release 0.5.14 ([#895](https://github.com/bvgroup-co/otf/issues/895)) ([b6c75ce](https://github.com/bvgroup-co/otf/commit/b6c75ce882036db379c7a133b594449a1de09650))
* **master:** release 0.5.15 ([#903](https://github.com/bvgroup-co/otf/issues/903)) ([4431892](https://github.com/bvgroup-co/otf/commit/44318925a004b8b0df128f88baadeb6f2c11adbf))
* **master:** release 0.5.16 ([#905](https://github.com/bvgroup-co/otf/issues/905)) ([9627c41](https://github.com/bvgroup-co/otf/commit/9627c4133ad88a8e80a64c40968f2fb597f75910))
* **master:** release 0.5.17 ([#907](https://github.com/bvgroup-co/otf/issues/907)) ([d4f5543](https://github.com/bvgroup-co/otf/commit/d4f5543f77cedd5639476c309c162a71e67a8238))
* **master:** release 0.5.18 ([#909](https://github.com/bvgroup-co/otf/issues/909)) ([dcb0dee](https://github.com/bvgroup-co/otf/commit/dcb0deeee523b9cfbff608dd446f4e0efde72b3b))
* **master:** release 0.5.19 ([#916](https://github.com/bvgroup-co/otf/issues/916)) ([00bd9f6](https://github.com/bvgroup-co/otf/commit/00bd9f6204ff8f150ea03ed448422d5d4292ba80))
* **master:** release 0.5.2 ([#872](https://github.com/bvgroup-co/otf/issues/872)) ([01bb8ac](https://github.com/bvgroup-co/otf/commit/01bb8acf6f0852736fc17905c1733d3755533188))
* **master:** release 0.5.20 ([#926](https://github.com/bvgroup-co/otf/issues/926)) ([0211846](https://github.com/bvgroup-co/otf/commit/021184665efca5f202e23f3b02d2472d09ac35e4))
* **master:** release 0.5.21 ([#934](https://github.com/bvgroup-co/otf/issues/934)) ([ada209d](https://github.com/bvgroup-co/otf/commit/ada209d90ce16084aeb6cfc1785df891a4da5577))
* **master:** release 0.5.22 ([#936](https://github.com/bvgroup-co/otf/issues/936)) ([9b447cc](https://github.com/bvgroup-co/otf/commit/9b447ccc1a22c71b29754c87621ec1885cb588c8))
* **master:** release 0.5.23 ([#940](https://github.com/bvgroup-co/otf/issues/940)) ([90a4bef](https://github.com/bvgroup-co/otf/commit/90a4befddab000a333d6b9c4e487e13359698a1b))
* **master:** release 0.5.24 ([#944](https://github.com/bvgroup-co/otf/issues/944)) ([5f2d355](https://github.com/bvgroup-co/otf/commit/5f2d355f5625ee9df87e0a55bafcc86c7780b693))
* **master:** release 0.5.3 ([#873](https://github.com/bvgroup-co/otf/issues/873)) ([0bfb54a](https://github.com/bvgroup-co/otf/commit/0bfb54a5f61886f56e6cf4d50d25a85637fa09a4))
* **master:** release 0.5.4 ([#875](https://github.com/bvgroup-co/otf/issues/875)) ([b1cf567](https://github.com/bvgroup-co/otf/commit/b1cf5671e750faf112c0f85aa3734d3d7acdf7f1))
* **master:** release 0.5.5 ([#876](https://github.com/bvgroup-co/otf/issues/876)) ([e76c1fc](https://github.com/bvgroup-co/otf/commit/e76c1fcaeaa48b731087e88e38c1d5bf7152d136))
* **master:** release 0.5.6 ([#877](https://github.com/bvgroup-co/otf/issues/877)) ([ec16dd1](https://github.com/bvgroup-co/otf/commit/ec16dd1eb6b3d9eaee19702a634e016cac8a8d07))
* **master:** release 0.5.7 ([#878](https://github.com/bvgroup-co/otf/issues/878)) ([81c6e14](https://github.com/bvgroup-co/otf/commit/81c6e148e45541188b49516dee171de0c7b190de))
* **master:** release 0.5.8 ([#883](https://github.com/bvgroup-co/otf/issues/883)) ([90973c4](https://github.com/bvgroup-co/otf/commit/90973c4f33aad48dab0c978796619ce08961c24c))
* **master:** release 0.5.9 ([#886](https://github.com/bvgroup-co/otf/issues/886)) ([3a2af16](https://github.com/bvgroup-co/otf/commit/3a2af1620d416464e96dfbed487e31feaf6f49eb))
* more tofu tests ([#764](https://github.com/bvgroup-co/otf/issues/764)) ([5812449](https://github.com/bvgroup-co/otf/commit/581244958f01f0081ee433f467d75767f112f205))
* parameterize ld flags in makefile ([92fd5a4](https://github.com/bvgroup-co/otf/commit/92fd5a456eb817e11d6537772e5938b9a497661a))
* **perf:** pre-allocate slices ([ccc8b6e](https://github.com/bvgroup-co/otf/commit/ccc8b6e0a6c3195ef239323574ce3b51aa86bce9))
* remove cache - negligible perf gain? ([3522cdf](https://github.com/bvgroup-co/otf/commit/3522cdfcc82587e097655249b4aa873293b19b33))
* remove debug statements ([c93b542](https://github.com/bvgroup-co/otf/commit/c93b5422af1c102c3d94c1dc5fa122e06803beb4))
* remove redundant connection param ([#774](https://github.com/bvgroup-co/otf/issues/774)) ([5b784c8](https://github.com/bvgroup-co/otf/commit/5b784c833335a946aa1f91945626fc510dc7cf5f))
* remove redundant jsonapiclient interface ([5aa153a](https://github.com/bvgroup-co/otf/commit/5aa153a9822d86714845509c5f15c962321382cd))
* remove unnecessary double html error ([53cb12d](https://github.com/bvgroup-co/otf/commit/53cb12d25d00c664daf7ebe7eb7fcd38e609fad5))
* remove unnecessary install-linter make task ([dc36aac](https://github.com/bvgroup-co/otf/commit/dc36aaca47a3c4595fd626806de02a2e9a031704))
* remove unnecessary link from widget heading ([318c390](https://github.com/bvgroup-co/otf/commit/318c39052ebcbbee187dbc2a08a0a456dab70352))
* remove unnecessary source ptr func ([0ef66e9](https://github.com/bvgroup-co/otf/commit/0ef66e9478ad0ffafdf54f1e06a97337cc9646aa))
* remove unnused go generate line ([f09cd42](https://github.com/bvgroup-co/otf/commit/f09cd4229f2dbee7977bfc615752825582a971e5))
* remove unused exchange code response ([4a966cd](https://github.com/bvgroup-co/otf/commit/4a966cd8cbfc1c4232c1ebe7b83c62044a2a8af2))
* remove unused func params ([93afe9b](https://github.com/bvgroup-co/otf/commit/93afe9b4afe23d23654026f5d774569c54a66523))
* remove unused go.mod replace directives ([74505b3](https://github.com/bvgroup-co/otf/commit/74505b3714947ed601af303129ae99c089508872))
* remove unused list components ([e7166ea](https://github.com/bvgroup-co/otf/commit/e7166ea1823eee4283e1a40b50f9c46c27875577))
* remove unused modd file watcher ([89c422d](https://github.com/bvgroup-co/otf/commit/89c422d9f4f81d7b4eb62cae84f5d2d01e23e34b))
* remove unused parameter ([8df5334](https://github.com/bvgroup-co/otf/commit/8df53340e0489127cab95307034e5f75b292671e))
* remove unused watch func ([5bc63b2](https://github.com/bvgroup-co/otf/commit/5bc63b2f8d3aa152299ebde321ba8c2430af0207))
* remove working comments ([a51716e](https://github.com/bvgroup-co/otf/commit/a51716e2cbda281f5433963f8b54692f4f49c9cf))
* require log chunk attributes ([00d61c8](https://github.com/bvgroup-co/otf/commit/00d61c83a00ef6df28079b823b6271a6b7165888))
* revert go test make task ([6d0b2a3](https://github.com/bvgroup-co/otf/commit/6d0b2a3fbeebb41227877b67f2d3d98239ad7bb8))
* screenshot test failures ([06443b1](https://github.com/bvgroup-co/otf/commit/06443b1034664ed4a4584171d5b6e511909daf64))
* test timeout subsystem for errors ([fe354c1](https://github.com/bvgroup-co/otf/commit/fe354c191378a209100b2c8b0e2936f6bd64dcc7))
* **test:** cover remote-state-sharing disabled case ([2bcafee](https://github.com/bvgroup-co/otf/commit/2bcafeeece97e8204a93cdf33e291a7731ba0383))
* **tests:** consistently refer to daemon as a daemon ([316900e](https://github.com/bvgroup-co/otf/commit/316900e0c81ac2bfd836d402493b070bee3159c1))
* tidy up navbar ([7a56987](https://github.com/bvgroup-co/otf/commit/7a56987bba515c3c048e77a87b1d0358ddf3e928))
* trigger new version of agent chart upon deploy ([#690](https://github.com/bvgroup-co/otf/issues/690)) ([155e026](https://github.com/bvgroup-co/otf/commit/155e026252c52d4ec7565f9bb7444b297bca16f7))
* trigger release ([e90e046](https://github.com/bvgroup-co/otf/commit/e90e0469c0a46a16112891b19a9e8877c790283b))
* **ui:** nicer icons for run source ([21c3c05](https://github.com/bvgroup-co/otf/commit/21c3c0552caa15d1b886ae83de368e55b130e66f))
* **ui:** replace multiple vcs tables with one ([36eece0](https://github.com/bvgroup-co/otf/commit/36eece0c29233128ba972214dbd6cb255b9a079c))
* unarchive ([c954c36](https://github.com/bvgroup-co/otf/commit/c954c36107c910192941393e366ee1b8a2e290f1))
* update algorithms ([a303feb](https://github.com/bvgroup-co/otf/commit/a303feb49eedd2c0f6afb0f6a96d820674e4ed31))
* update Alpine to v3.23 ([#849](https://github.com/bvgroup-co/otf/issues/849)) ([1721470](https://github.com/bvgroup-co/otf/commit/17214707b969712dcff77d2553b992e875dac1e4))
* update doc screenshots ([#796](https://github.com/bvgroup-co/otf/issues/796)) ([0677c07](https://github.com/bvgroup-co/otf/commit/0677c0770544f4abb431f077b5406872ed55e290))
* update docs ([4e971dc](https://github.com/bvgroup-co/otf/commit/4e971dcf8d7f004d25be88667f5e7943c135dfb7))
* update screenshots ([b17ffa4](https://github.com/bvgroup-co/otf/commit/b17ffa45394cfa23343637529df4ff46bcac97ab))
* upgrade all deps ([299c32d](https://github.com/bvgroup-co/otf/commit/299c32dfb5bae3641e43ab79c2d79806efcc1410))
* upgrade dependencies ([b79f46a](https://github.com/bvgroup-co/otf/commit/b79f46aba79dcb996096621c8b606f68b8d1db26))
* upgrade dependencies ([59eb979](https://github.com/bvgroup-co/otf/commit/59eb97996785328e78c31f2372cfce889f5ef7cb))
* upgrade templ ([21a105e](https://github.com/bvgroup-co/otf/commit/21a105ec1c6027d10d8be81531f1463acc3fe3f2))
* upgrade vulnerable markdown go mod ([781e0f6](https://github.com/bvgroup-co/otf/commit/781e0f6e047abe662336250e679797f1b3ed0752))
* use builtin run watcher for integration tests ([e0299d3](https://github.com/bvgroup-co/otf/commit/e0299d3b791af3b072ae7cb69ffefe22840c7042))
* use constants where they already exist ([4551222](https://github.com/bvgroup-co/otf/commit/45512221b1708a3fbd00881f225d698753b0b83a))
* use forked sse lib's module path ([fc9b138](https://github.com/bvgroup-co/otf/commit/fc9b13865844062570ffbeb7d8c57bdf5ae50b91))
* use go tool for templ ([403974f](https://github.com/bvgroup-co/otf/commit/403974f5e7cb3d5a44b90b1b104ed76e9693667e))
* use modern go features ([7983154](https://github.com/bvgroup-co/otf/commit/79831540169796f9fd03793bede711dbb1b8afa0))
* use new surl v2 lib ([0c5b45c](https://github.com/bvgroup-co/otf/commit/0c5b45cb32a7e7743b11631b4a14f65494141039))
